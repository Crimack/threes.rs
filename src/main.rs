...
fn main() {
    ...
    opts.optflag("t", "terminal", "run as a playable version in the terminal. It's probably best to play this in a fresh terminal, or one that you don't mind having repeatedly wiped.");
